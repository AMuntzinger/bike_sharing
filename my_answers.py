...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_i_h += np.matmul(X[:, None], hidden_error_term) # dim (input, hidden) e.g. (3,2)
        # Weight step (hidden to output)
        delta_weights_h_o += output_error_term * hidden_outputs[:, None] # dim (hidden, output) e.g. (2,1)
